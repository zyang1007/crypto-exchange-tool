        ...
        while True:
            try:
                ...
                if current_price <= self.price_min:
                    print("Price has reached below the lower boundary. STOP...")
                    time.sleep(time_interval)
                    continue
                elif current_price >= self.price_max:
                    print("Price has reached the upper boundary. STOP...")
                    time.sleep(time_interval)
                    continue
                ...
                if order is None:
                    print("Order not placed due to insufficient balance or other conditions.")
                else:
